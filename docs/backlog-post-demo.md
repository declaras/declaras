...
- **Columna "ahorro logrado"**: `optimizador.ahorro_marginal` existe pero nada lo conecta al render. ⚠️ Los ahorros marginales NO son aditivos (sumar contra el mismo base sobreestima hasta 64% con el cap copado): la UI debe acumular.
